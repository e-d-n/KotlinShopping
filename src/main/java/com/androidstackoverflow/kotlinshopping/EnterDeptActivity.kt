...
import kotlinx.android.synthetic.main.activity_enter_dept.*


class EnterDeptActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_enter_dept)
